                    ...
                    <Card.Text>
                        <Container fluid>
                            <form name = "employeeUpdate" onSubmit={this.handleSubmit}>
                                ...
                                <Button type="submit" size="sm" variant="primary" className="my-3" >Update Employee</Button>
                                <Alert variant={this.state.alertColor} 
                                    show={this.state.alertVisible} 
                                    onClose={() => this.setState({alertVisible: false})} 
                                    dismissible>{this.state.allertMessage}</Alert>
                            </form>
                        </Container>
                    </Card.Text>
                </Card.Body>
